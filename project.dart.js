...
$.showPopUpWindow = function(question, answers) {
  $.document().query$1('#pop-up').set$hidden(false);
  $.document().query$1('#question').set$text(question);
  var t1 = $.index(answers, 0);
  $.document().query$1('#answer1').set$text(t1);
  t1 = $.index(answers, 1);
  $.document().query$1('#answer2').set$text(t1);
  t1 = $.index(answers, 2);
  $.document().query$1('#answer3').set$text(t1);
  t1 = $.index(answers, 3);
  $.document().query$1('#answer4').set$text(t1);
};
...
$.drawDemo = function() {
  var context = $.query('#canvas').get$context2d();
  context.rect$4(0, 0, 960, 500);
  context.set$fillStyle('blue');
  context.fill$0();
  context.set$fillStyle('black');
  context.fillText$3('This should be the map', 200, 200);
};
...
$.main = function() {
  $.query('#pop-up').set$hidden(true);
  $.drawDemo();
  $.ListFactory_List(null);
  $.showPopUpWindow('Question', ['ans1', 'ans2', 'ans3', 'ans4']);
};
